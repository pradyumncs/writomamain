                    ...
                    <div className="hidden lg:grid lg:grid-cols-2 lg:gap-8">
                                ...
                                <div className="space-y-6">
                                    <div className="relative">
                                        <textarea
                                            ...
                                            placeholder="Put your AI-generated text here to humanize it..."
                        ...
                        <div className="group">
                            <div className="bg-white rounded-xl border border-gray-200 p-8 shadow-sm">
                                <div className="flex items-center justify-between mb-6">
                                    ...
                                    {humanized && (
                                        <div className="flex gap-2">
                                            <Button size="sm" variant="outline" className="rounded-md hover:bg-gray-50 transition-colors" onClick={handleCopy}>
                                                {copied ? (
                                ...
                                <div className="relative">
                                    <div className="w-full h-80 p-6 bg-white border border-gray-200 rounded-lg text-sm leading-relaxed overflow-y-auto transition-all duration-200">
                                        {isLoading ? (
                    ...
                    <div className="lg:hidden space-y-8">
                        ...
                        <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                            <div className="flex items-center justify-between mb-6">
                                ...
                                {humanized && (
                                    <div className="flex gap-2">
                                        <Button size="sm" variant="outline" className="rounded-md transition-colors" onClick={handleCopy}>
                                            {copied ? (
                                                <div className="flex items-center gap-1">
                            ...
                            <div className="relative">
                                <div className="w-full h-64 p-4 bg-white border border-gray-200 rounded-lg text-sm leading-relaxed overflow-y-auto">
                                    {isLoading ? (
                                        <div className="flex flex-col items-center justify-center h-full text-center">
